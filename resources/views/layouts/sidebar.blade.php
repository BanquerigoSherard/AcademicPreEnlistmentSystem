    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
          <img src="images/ccsLogo.png" alt="CCS Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          <span class="brand-text font-weight-light">CCS Enlistment</span>
        </a>
        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            ...
            <ul class="nav nav-sidebar flex-column position-absolute rounded logout-btn" style="bottom: 10px">
                <li class="nav-item">
